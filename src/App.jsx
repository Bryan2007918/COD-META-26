...
export default function App() {
  ...
  // SPLASH: espera 2.5s y luego navega segun estado de auth
  useEffect(function() {
  ...
  // Cuando splash termina Y loading termina, navegar
  useEffect(function() {
  ...
  function doReg() {
    ...
    createUserWithEmailAndPassword(auth, form.correo.trim(), form.pass)
      .then(function(cred) {
        ...
        var datos = { nombre: nombreCompleto, correo: form.correo.trim().toLowerCase(), dorsal: dorsal, telefono: form.telefono || "", edad: form.edad || "", genero: form.genero, talla: form.talla || "", contactoEmergencia: form.contactoEmergencia || "", fechaReg: new Date().toLocaleDateString("es-MX"), evento: "Codigo 26" };
  ...
  if (scr === "welcome" && userData) return W(
    <div style={{ display:"flex", flexDirection:"column", justifyContent:"center", alignItems:"center", minHeight:"100vh", padding:24, textAlign:"center" }}>
      ...
      <div style={{ background:"rgba(16,185,129,0.08)", borderRadius:12, padding:"12px 16px", width:"100%", marginTop:12, border:"1px solid rgba(16,185,129,0.15)" }}>
        ...
        <div style={{ fontSize:11, color:C.muted, marginTop:2 }}>Tu registro esta seguro. Puedes cerrar la app y volver a entrar con tu correo y contrasena sin perder nada.</div>
      </div>
